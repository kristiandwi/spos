	...
	<script src="<?php echo ASSETS_; ?>js/jquery.js"></script>
	<!-- Popper Jquery -->
	<script src="<?php echo ASSETS_; ?>js/popper.min.js"></script>
	<!-- Bootstrap jQuery -->
	<script src="<?php echo ASSETS_; ?>js/bootstrap.min.js"></script>
	<!-- magnific-popup -->
	<script src="<?php echo ASSETS_; ?>js/jquery.magnific-popup.min.js"></script>
	<!-- Owl Carousel -->
	<script src="<?php echo ASSETS_; ?>js/owl.carousel.min.js"></script>
	<!-- Color box -->
	<script src="<?php echo ASSETS_; ?>js/jquery.colorbox.js"></script>
	<!-- Template custom -->
	<script src="<?php echo ASSETS_; ?>js/custom.js"></script>
