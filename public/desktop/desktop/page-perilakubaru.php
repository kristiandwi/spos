<?php 
/*
Template Name: Page Perilaku Baru
*/
?>
		...
		<div class="container pl-0 pr-0">
			<div class="row ts-gutter-20">
				<div class="col-lg-8 col-md-12 pad-r">
					...
					query_posts('author=-200&no_found_rows=true&showposts=4&tag=perilaku-baru,setop-penularan-covid-19,ingat-pesan-ibu,solopos-lawan-covid-19,setop-penularan-covid-19,cek-fakta-corona');
                    $loop_no = 1;
		...
		<div class="container pl-0 pr-0">
			<div class="ts-grid-box">
				...
				<?php query_posts(array('meta_key' => 'post_feature',
										...
										'orderby' => 'date',
										//'cat' => 2088,
										'tag' => 'perilaku-baru,setop-penularan-covid-19,ingat-pesan-ibu,solopos-lawan-covid-19,setop-penularan-covid-19,cek-fakta-corona'
                                        //'offset' => 4,
			...
			<div class="row ts-gutter-30">
				<div class="col-lg-8 col-md-12">
					...
					<?php
						...
						query_posts('author=-200&posts_per_page=16&tag=perilaku-baru,setop-penularan-covid-19,ingat-pesan-ibu,solopos-lawan-covid-19,setop-penularan-covid-19,cek-fakta-corona&offset=4&paged='.$paged);
                        $loop_no = 1;
                        if (have_posts()) : while (have_posts()) : the_post();
