		...
		<div class="container pl-0 pr-0">
			<div class="row ts-gutter-20">
				<div class="col-lg-8 col-md-12 pad-r">
					...
					<?php
					query_posts('author=-200&no_found_rows=true&showposts=4&tag=uksw,uksw-salatiga,prestasi-uksw,prestasi-uksw-salatiga');
                    $loop_no = 1;
		...
		<div class="container pl-0 pr-0">
			<div class="ts-grid-box">
				<h2 class="block-title">
					 <span class="title-angle-shap"> Prestasi </span>
				</h2>
				...
				<?php query_posts(array('showposts' => 8,
					...
					'orderby' => 'date',
					//'cat' => 2088,
					'tag' => 'prestasi-uksw,prestasi-uksw-salatiga'
                    //'offset' => 4,
			...
			<div class="row justify-content-center">
				<div class="col-lg-10">
					<div class="banner-img">
						<?php include(TEMPLATEPATH.'/part/uksw/ads/ads-leaderboard-top.php'); ?>
					</div>
				</div>
				<!-- col end -->
			</div>
			...
			<div class="row ts-gutter-30">
				<div class="col-lg-8 col-md-12">
					...
					<?php
						...
						query_posts('author=-200&posts_per_page=16&tag=uksw,uksw-salatiga,prestasi-uksw,prestasi-uksw-salatiga,foto-uksw-salatiga&paged='.$paged);
                        $loop_no = 1;
                        if (have_posts()) : while (have_posts()) : the_post();
