	...
	<body>
		...
		<div class="top-wrap uk-position-relative uk-light uk-background-secondary">
			...
			<div class="uk-cover-container uk-light uk-flex uk-flex-middle" style="height: 23vw">				
				...
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="https://www.solopos.com/assets/ads/sbbi/banner-sbbi.jpg"
				data-sizes="12vw"
		...
		<section class="uk-section uk-section-muted">
			<div class="uk-container">
				<h2 class="uk-text-bold">Info Lainnya</h2>
									...
									<div>
										<div class="uk-card uk-card-default uk-card-small" style="box-shadow: none;">
											<div class="uk-card-media-top">
												<a href="<?php the_permalink(); ?>"><img src="<?php echo post_image('medium', 562, 562); ?>" alt="<?php the_title(); ?>" width="620" height="350"></a>
											</div>
											<div class="uk-card-header">
												<div class="uk-grid-small uk-flex-middle" data-uk-grid>
													<div class="uk-width-auto">
														<img class="uk-border-circle" alt="" width="40" height="40" src="https://images.solopos.com/2019/10/avatar-solopos-370x370.jpg">
													</div>
													<div class="uk-width-expand">
														<h6 class="uk-margin-remove-bottom uk-text-bold"><?php echo author_name() ?></h6>
														<p class="uk-text-meta uk-margin-remove-top uk-text-small"><time datetime="2016-04-01T19:00"><?php the_time('j F Y'); ?></time></p>
													</div>
												</div>
											</div>
											<div class="uk-card-body">
												
													<a class="uk-button uk-button-text uk-text-bold uk-margin-small" href="<?php the_permalink(); ?>">
														<h4 class="uk-margin-small-bottom uk-text-bold"><?php the_title(); ?></h4>
													</a>
