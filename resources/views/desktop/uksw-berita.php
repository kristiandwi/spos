			...
			<div class="row ts-gutter-30">
				<div class="col-lg-8 col-md-12">
					...
					<?php
						...
						query_posts('author=-200&posts_per_page=10&cat=-655246&tag=uksw,uksw-salatiga,prestasi-uksw,prestasi-uksw-salatiga,foto-uksw-salatiga&paged='.$paged.'');
                        $loop_no = 1;
								...
								<div class="row">
									<div class="col-md-5">
										<div class="post-thumb">
											<img src="<?php echo post_image('thumbnail', 280, 190); ?>" alt="Image" style="object-fit: cover; height: 167px; width: 250px;">
