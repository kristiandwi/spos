<?php 
/*
Template Name: Page Perilaku Baru Cek Fakta
*/
?>
			...
			<div class="row ts-gutter-30">
				<div class="col-lg-8 col-md-12">
					<h2 class="block-title">
						<span class="title-angle-shap"> Cek Fakta Corona</span>
					</h2>
					<div class="row ts-gutter-20 align-items-center">
					<?php
                        //$latest = new WP_Query('cat=76259&posts_per_page=15&order=DESC');
                        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
						query_posts('author=-200&posts_per_page=10&tag=cek-fakta-corona&paged='.$paged.'');
                        $loop_no = 1;
