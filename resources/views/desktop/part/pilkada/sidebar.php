                ...
                <div class="col-lg-4">
					<div class="sidebar">
						<div class="sidebar-widget ads-widget">
							<div class="ads-image">
								<?php include(TEMPLATEPATH.'/part/pilkada/ads/ads-sidebar-top.php'); ?>
							</div>
						</div><!-- widget end -->
						...
						<div class="sidebar-widget ads-widget">
								<?php include(TEMPLATEPATH.'/part/pilkada/ads/ads-sidebar-bottom.php'); ?>
						</div><!-- widget end -->
						...
						<div class="sidebar-widget">
							<div class="ts-category">
								<ul class="ts-category-list">
									<li>
										<a href="#" style="background-image: url(<?php echo ASSETS_PILKADA; ?>images/news/category/category1.png)">
											<span> Profile Calon Bupati </span>
											<span class="bar"></span> 
										</a>
									</li><!-- end list 1 -->
									<li>
										<a href="#" style="background-image: url(<?php echo ASSETS_PILKADA; ?>images/news/category/category2.png)">
											<span> Profile Calon Walikota </span>
											<span class="bar"></span> 
										</a>
									</li><!-- end list 2 -->
									<li>
										<a href="#" style="background-image: url(<?php echo ASSETS_PILKADA; ?>images/news/category/category3.png)">
											<span> Profile Calon Bupati </span>
											<span class="bar"></span> 
										</a>
									</li><!-- end list 3 -->
									<li>
										<a href="#" style="background-image: url(<?php echo ASSETS_PILKADA; ?>images/news/category/category4.png)">
											<span> Profile Calon Wakil Bupati </span>
											<span class="bar"></span> 
										</a>
									</li><!-- end list 4 -->
									<li>
										<a href="#" style="background-image: url(<?php echo ASSETS_PILKADA; ?>images/news/category/category5.png)">
											<span> Profile Calon Bupati </span>
											<span class="bar"></span> 
										</a>
									</li><!-- end list 5 -->
