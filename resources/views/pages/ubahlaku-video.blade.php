	...
	<section class="main-content category-layout-1 pt-0">
		<div class="container">
			<div class="post-header-area" align="center">
				<h2 class="post-title title-lg">Galeri Video</h2>
			</div>
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-6 col-md-6">
					<div class="post-block-style clearfix">
						<div class="post-thumb">
							<img class="img-fluid" src="https://i1.ytimg.com/vi/{{ $ids }}/mqdefault.jpg" alt="Thumbnail" style="object-fit: cover; height: 275px;">
				...
				<div class="col-12 mt-3">
					<div class="load-more-btn text-center">
							<a class="btn" href="https://www.youtube.com/playlist?list=PLMNxf31imllG4UzyrB8vSakTZ980IJV8G" target="_blank"> Load More ... </a>
					</div>
				</div><!-- col end -->
