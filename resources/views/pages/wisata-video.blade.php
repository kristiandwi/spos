	...
	<section class="main-content category-layout-1 pt-0">
		<div class="container">
			<div class="post-header-area" align="center">
				<h2 class="post-title title-lg">Galeri Video Wisata Joglosemar</h2>
			</div>
			...
			<div class="col-lg-12">
				...
				<div class="col-12 mt-3">
					<div class="load-more-btn text-center">
							<a class="btn" href="https://www.youtube.com/channel/UCfdq2dv6zodZqqWpvc3U-MA" target="_blank"> Load More ... </a>
					</div>
				</div><!-- col end -->
